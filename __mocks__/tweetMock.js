module.exports = mockData = {
    "text": "RT @PostGradProblem: In preparation for the NFL lockout, I will be spending I ♥ when marketers talk about the ☁. #blessed", 
    "truncated": true, 
    ...
    "entities": {
          ...
          "urls": ["http://test1.com" , "https://test2.com"], 
          "hashtags": [
            {
                  "text": "PGP", 
                  "indices": [
